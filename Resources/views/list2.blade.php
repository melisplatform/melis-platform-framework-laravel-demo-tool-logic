...
<table class="table">
    ...
    @foreach($logs As $log)
        <tr>
            <td>{{ $log->getId() }}</td>
            <td>{{ $log->getLog()->log_title }}</td>
            <td>{{ $log->getLog()->log_message }}</td>
            <td>{{ $log->getLog()->log_user_id }}</td>
            <td>{{ $log->getLog()->log_type_id }}</td>
            <td>{{ $log->getLog()->log_item_id }}</td>
            <td>{{ $log->getLog()->log_date_added }}</td>
        </tr>
    @endforeach
</table>
